...
# Local test on the same Wi-Fi: your computer's LAN IP, e.g. http://localhost:8000
# Deployed: your public address, e.g. https://digicards-production-ac41.up.railway.app
BASE_URL = os.getenv("BASE_URL", "https://digicards-production-ac41.up.railway.app")
